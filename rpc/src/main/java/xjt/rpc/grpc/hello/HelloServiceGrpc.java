...
public final class HelloServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<xjt.rpc.grpc.hello.HelloRequest,
      xjt.rpc.grpc.hello.HelloReply> getSayMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Say",
      requestType = xjt.rpc.grpc.hello.HelloRequest.class,
      responseType = xjt.rpc.grpc.hello.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<xjt.rpc.grpc.hello.HelloRequest,
      xjt.rpc.grpc.hello.HelloReply> getSayMethod() {
    io.grpc.MethodDescriptor<xjt.rpc.grpc.hello.HelloRequest, xjt.rpc.grpc.hello.HelloReply> getSayMethod;
    if ((getSayMethod = HelloServiceGrpc.getSayMethod) == null) {
      synchronized (HelloServiceGrpc.class) {
        if ((getSayMethod = HelloServiceGrpc.getSayMethod) == null) {
          HelloServiceGrpc.getSayMethod = getSayMethod =
              io.grpc.MethodDescriptor.<xjt.rpc.grpc.hello.HelloRequest, xjt.rpc.grpc.hello.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Say"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  xjt.rpc.grpc.hello.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  xjt.rpc.grpc.hello.HelloReply.getDefaultInstance()))
  ...
  public static abstract class HelloServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void say(xjt.rpc.grpc.hello.HelloRequest request,
        io.grpc.stub.StreamObserver<xjt.rpc.grpc.hello.HelloReply> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                xjt.rpc.grpc.hello.HelloRequest,
                xjt.rpc.grpc.hello.HelloReply>(
                  this, METHODID_SAY)))
          .build();
    }
  }
  ...
  public static final class HelloServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<HelloServiceBlockingStub> {
    ...
    /**
     */
    public xjt.rpc.grpc.hello.HelloReply say(xjt.rpc.grpc.hello.HelloRequest request) {
  ...
  public static final class HelloServiceFutureStub extends io.grpc.stub.AbstractFutureStub<HelloServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<xjt.rpc.grpc.hello.HelloReply> say(
        xjt.rpc.grpc.hello.HelloRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY:
          serviceImpl.say((xjt.rpc.grpc.hello.HelloRequest) request,
              (io.grpc.stub.StreamObserver<xjt.rpc.grpc.hello.HelloReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class HelloServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return xjt.rpc.grpc.hello.HelloProto.getDescriptor();
    }
